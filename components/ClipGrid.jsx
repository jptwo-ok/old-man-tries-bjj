    ...
    >
      ...
      {hovering && clip.video_url && (
        <div className="absolute bottom-1.5 inset-x-0 flex justify-center pointer-events-none">
          <span
            className="font-mono text-[10px] font-semibold tracking-wide text-chalk px-2.5 py-1 rounded-full bg-black/70"
          >
            click to vote
          </span>
        </div>
